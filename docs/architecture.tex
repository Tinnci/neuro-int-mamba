...
\end{equation}
where $\theta$ and $\dot{\theta}$ represent joint positions and velocities. This mimics muscle spindle sensitivity, providing immediate corrections to maintain physical stability without requiring high-level cognitive overhead.
...
\begin{itemize}
    \item \textbf{Tactile Spatial Prior}: Uses 1D Convolutional layers to capture spatial correlations in array-based tactile sensors (e.g., GelSight or BioTac).
